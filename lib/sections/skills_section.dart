  ...
  List<Widget> _buildCategories(BuildContext context, bool isMobile) {
    final categories = [
      ...
      _SkillCategory(
        ...
        [
          _Skill(FontAwesomeIcons.docker.data, 'Docker'),
          _Skill(Icons.hub, 'Kubernetes'),
          _Skill(Icons.account_tree, 'Azure DevOps'),
          _Skill(FontAwesomeIcons.github.data, 'GitHub Actions'),
          _Skill(FontAwesomeIcons.gitlab.data, 'GitLab CI'),
      ...
      _SkillCategory(
        ...
        [
          ...
          _Skill(FontAwesomeIcons.python.data, 'Python'),
          _Skill(FontAwesomeIcons.java.data, 'Java'),
        ],
      ),
      _SkillCategory(
        'Frontend & Mobile',
        ...
        [
          ...
          _Skill(FontAwesomeIcons.js.data, 'JavaScript'),
        ],
      ),
      _SkillCategory(
        'Practices & Tools',
        ...
        [
          ...
          _Skill(FontAwesomeIcons.git.data, 'Git'),
          _Skill(FontAwesomeIcons.figma.data, 'Figma'),
          _Skill(FontAwesomeIcons.jira.data, 'Jira'),
        ],
      ),
    ];
